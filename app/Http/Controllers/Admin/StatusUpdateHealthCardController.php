                ...
                if ($sponsor_id != $authmemberid) {
                    ...
                    if ($user->type == 'admin') {
                        $data_wallet = array(
                            ...
                            'health_card_amount' =>  $lastremainingamount->remainng_amount,
                            'admin_transfered_amt' =>  $lastremainingamount->remainng_amount,
                    ...
                    if ($user->type == 'city-head-hcms') {
                        ...
                        $healh_card_amount = $lastremainingamount->remainng_amount;
