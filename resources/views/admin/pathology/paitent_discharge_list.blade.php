                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                      ...
                                                      <td>
                                                        ...
                                                        <a target="_blank" href="{{ url('/') }}/admin/view-pathology-paitent-bill/{{$paitent['id']}}" title="Click to View Inovice this row"><i class="fas fa-file-invoice" style='font-size:20px;color:blue'></i></a>
                                                        </a>
                                                        @if(Auth::guard('admin')->user()->type == 'Health_card_Customer')
                                                        <li><a href="{{ url('/') }}/admin/Add-Edit-PReview/{{$paitent['id']}}" title="Click to edit this row"><i class="fa fa-star"></i></a></li>
                                                        @endif
                                                    </td>
                                                    </tr>
                                                @endforeach
