            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form class="forms-sample" @if(empty($createPathology['id'])) action="{{ url('admin/ADD-Edit-Pathology') }}" @else action="{{ url('admin/ADD-Edit-Pathology/'.$createPathology['id']) }}" @endif method="post" enctype="multipart/form-data">
                            @csrf
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label for="health_card_amount">Pathology Image</label>
                                        <input type="file" class="form-control" name="image" id="image" @if(!empty($createPathology['image'])) value="{{ $createPathology['image'] }}" @else value="{{ old('image') }}" @endif @if($createPathology['id']!="") disabled="" @else required="" @endif required=""   >
                                    </div>
                                </div>
                            </div>
                             <!-- /.card-body -->
