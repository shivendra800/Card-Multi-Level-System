    ...
    <div class="container-fluid">
        <div class="row">
            ...
            @if(Auth::guard('admin')->user()->type == 'Pathology')
              <a href="{{ url('admin/paitent-testcom-list') }}" aligin="left" class="btn btn-info">Back</a>
              @endif
              @if(Auth::guard('admin')->user()->type == 'Health_card_Customer')
              <a href="{{ url('admin/Pathology-wise-customer-Invoice') }}" aligin="left" class="btn btn-info">Back</a>
              @endif
            <div class="col-md-12">
                <!-- general form elements -->
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">View<small>  Paitent Bill Details </small></h3>
                            ...
                            <div class="col-md-12">
                                <div class="card-body">
                                    ...
                                    aria-describedby="example1_info">
                                        ...
                                        <tbody>
                                            @foreach ($paitenttestList as $testlist )
                                            <tr>
                                                  <td>{{ $testlist['test_name'] }}</td>
                                                  <td>{{ $testlist['test_rate'] }}</td>
