    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                ...
                <h1>Path Health Card Customer</h1>
            ...
            <div class="card card-primary">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card-body">
                            <form class="forms-sample" action="{{ url('admin/path-HC-cust-Details-Search') }}"  method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <tr>
                                      ...
                                      <td>
                                        ...
                                        <div style="display:inline-flex;">
                                             ...
                                             <td>
                                               <a title="View Details Details" href="{{ url('admin/pathHealthCard-Cust-view/'.$createcard->id ) }}"<i style="font-size:25px;" class="fa fa-info-circle"></i></a>
                                             </td>
