                                                ...
                                                <tr>
                                                      ...
                                                      <td>
                                                        <ul>
                                                            ...
                                                            <li>  <a target="_blank" href="{{ url('/') }}/admin/view-pathology-paitent-bill/{{$paitent['id']}}" title="Click to View Inovice this row"><i class="fas fa-file-invoice" style='font-size:20px;color:blue'></i></a></li>
