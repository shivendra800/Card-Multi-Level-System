            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title"> {{ $title }}<small> Admit Path Paitent Details </small></h3>
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form class="forms-sample" @if(empty($EditPaitent['id'])) action="{{ url('admin/add-pathpaitent-details') }}" @else action="{{ url('admin/add-pathpaitent-details/'.$EditPaitent['id']) }}" @endif method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <label for="paitent_name">Path Paitent Name</label>
                                    ...
                                    <div class="form-group">
                                        <label for="paitent_total_bill">Patient Total Bill ({{ $totalPaitentTypeTest }})</label>
                                        <input type="text" readonly value="{{ $totalPaitentTypeTest }}" class="form-control" name="paitent_total_bill" onkeyup="discountamunt();" id="paitent_total_bill" @if(!empty($EditPaitent['paitent_total_bill'])) value="{{ $EditPaitent['paitent_total_bill'] }}" @else value="{{ old('paitent_total_bill') }}" @endif  placeholder="Enter paitent_total_bill" required="" >
                                    </div>
                                   

                                    <div class="form-group">
                                        <label for="finall_bill">Pathology Amount After Company Commission</label>
                            ...
                            <div class="col-md-6">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" readonly name="paitent_mobile" @if(!empty($EditPaitent['paitent_mobile'])) value="{{ $EditPaitent['paitent_mobile'] }}" @else value="{{ old('paitent_mobile') }}" @endif onKeyDown="if(this.value.length==10 && event.keyCode>47 && event.keyCode < 58)return false;" class="form-control @error('paitent_mobile')
                                        is-invalid
                                    ...
                                    {{-- <div class="form-group">
                                        <label for="health_card_amount">Pathology Discharge Slip</label>
