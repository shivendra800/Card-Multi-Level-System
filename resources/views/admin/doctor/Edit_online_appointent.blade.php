        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form class="forms-sample" @if(empty($AppoimentList['id'])) action="{{ url('admin/Doc-Edit-online-appointent') }}" @else action="{{ url('admin/Doc-Edit-online-appointent/'.$AppoimentList['id']) }}" @endif method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
