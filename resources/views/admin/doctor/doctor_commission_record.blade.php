            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form class="forms-sample" @if(empty($createhospital['id'])) action="{{ url('admin/Doctor-commisison-reciver') }}" @else action="{{ url('admin/Doctor-commisison-reciver/'.$createhospital['id']) }}" @endif method="post" enctype="multipart/form-data">
                            @csrf
                        <div class="row mt-4">
