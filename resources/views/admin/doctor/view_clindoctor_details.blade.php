                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title"> View<small> Clinic Doctor  Detials</small></h3>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="clininc_name" id="clininc_name" @if(!empty($createhospital['clininc_name'])) value="{{ $createhospital['clininc_name'] }}" @else value="{{ old('clininc_name') }}" @endif placeholder="Enter Full Name" readonly>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="assign_district">Doctor District</label>
                                        ...
                                        <div class="form-group">
                                            <label for="pincode">Doctor Pincode</label>
                                            <input type="number"
                                        ...
                                        <div class="form-group">
                                            <label for="mobile">Doctor Mobile No</label>
                            ...
                            <div class="col-md-6">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label for="assign_state">Doctor State</label>
                                        <select name="assign_state" id="assign_state"
                                        class="form-control  @error('assign_state') is-invalid @enderror"
                                        value="{{ old('state') }}" id="assign_state" onchange="getassigndiststatewise();" readonly>
                        ...
                        <div class="card-footer" align="center">
                            <div class="btn btn-success"><a href="{{url('/')}}/admin/Doctor-List"  style="color: white">Back</a></div>
                        </div>
                    </form>
