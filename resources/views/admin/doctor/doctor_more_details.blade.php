...
@section('content')
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Clinic Multiple Details :</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                    ...
                    <div class="col-md-8 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                @endif
                                {{-- error meg --}}
                                <form class="forms-sample" action="{{ url('admin/Doctor-More-Details/'.$gethospitalWiseDetails['id']) }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                ...
                                <table id="sections" class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{ $image['id'] }}</td>
                                            <td>
                                                <img style="width: 60px; height:60px;" src=" {{ asset('admin_assets/uploads/doctor/small/'.$image['image']) }}" </td>
                                            <td>
                    ...
                    <div class="col-md-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="forms-sample" action="{{ url('admin/ADD-Doctor-Specialization/'.$gethospitalWiseDetails['id']) }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-group">
                                        <div class="field_wrapper">
                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <hr>
                                <form class="forms-sample" action="{{ url('admin/Doctor-Details/'.$gethospitalWiseDetails->id) }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3">
                                             ...
                                             <div class="col-lg-3">
                                                <div class="form-group">
                                                    <div class="field_wrapper">
                                                        <label for="">Time Firday -Saturday</label>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    <div class="field_wrapper">
                                                        <label for="">Clinic Description</label>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    <div class="field_wrapper">
                                                        <label for="">Clinic Sort Description</label>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    <div class="field_wrapper">
                                                        <label for="">Clinic Highlight Point 1</label>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    <div class="field_wrapper">
                                                        <label for="">Clinic Highlight Point 2</label>
