        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form class="forms-sample" @if(empty($EditPaitent['id'])) action="{{ url('admin/add-Doc-paitent-details') }}" @else action="{{ url('admin/add-Doc-paitent-details/'.$EditPaitent['id']) }}" @endif method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card-body">
                                    <div class="form-group">
                                        <label for="paitent_caused_disease">paitent_caused_disease</label>
                                        <input type="text" class="form-control" name="paitent_caused_disease" id="paitent_caused_disease"  placeholder="Enter paitent_caused_disease" required="" >
                                    </div>
                                    <div class="field_wrapper">
                                        <div>
                                            <input type="text" name="pre_medicine[]" value="" placeholder="pre_medicine_name" required="">
                                            <input type="text" name="medicine_mg[]" value="" placeholder="medicine_mg" required="">
                                            <input type="number" name="dose_date[]" value="" placeholder="dose_date" required="">
                            ...
                            <div class="col-md-6">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="form-control @if ($errors->has('hospital_discharge_slip')) is-invalid @endif" name="hospital_discharge_slip" id="image" @if(!empty($createhospital['hospital_discharge_slip'])) value="{{ $createhospital['hospital_discharge_slip'] }}" @else value="{{ old('hospital_discharge_slip') }}" @endif  >
                                        @if ($errors->has('hospital_discharge_slip'))
                                        <div class="invalid-feedback">{{$errors->first('hospital_discharge_slip')}}</div>
                                      @endif
                                    </div>
                                </div>
                            </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        var fieldHTML = '<div><input type="text" required="" name="pre_medicine[]" placeholder="pre_medicine" value=""/><input type="text" required="" name="medicine_mg[]" placeholder="medicine_mg" value=""/><input type="number" required="" name="dose_date[]" placeholder="dose_date" value=""/><a href="javascript:void(0);" class="remove_button">Remove</a></div>'; //New input field html 
