    ...
    <div class="container-fluid">
        <div class="row">
            ...
            @if(Auth::guard('admin')->user()->type == 'Hospital')
              <a href="{{ url('admin/paitent-disharge-list') }}" aligin="left" class="btn btn-info">Back</a>
              @endif
              @if(Auth::guard('admin')->user()->type == 'Health_card_Customer')
              <a href="{{ url('admin/hospital-Invoice-Customer-wise') }}" aligin="left" class="btn btn-info">Back</a>
              @endif
            <div class="col-md-12">
