            ...
            <div class="card card-primary">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card-body">
                            <form class="forms-sample" action="{{ url('admin/HealthCard-customer-Details-Search') }}"  method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <tr>
                                      ...
                                      <td>
                                        ...
                                        <div style="display:inline-flex;">
                                             ...
                                             <td>
                                               <a title="View Details Details" href="{{ url('admin/HealthCard-customer-view/'.$createcard->id ) }}"<i style="font-size:25px;" class="fa fa-info-circle"></i></a>
                                             </td>
