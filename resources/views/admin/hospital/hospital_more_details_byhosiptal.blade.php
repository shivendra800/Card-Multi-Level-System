...
@section('content')
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Hospital Multiple Images :</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                    ...
                    <div class="col-md-8 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                @endif
                                {{-- error meg --}}
                                <form class="forms-sample" action="{{ url('admin/Hospital-Additional-Details/') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        <label for="gethospitalWiseDetails1_name">Hospital Name</label>
                                        &nbsp;{{ $gethospitalWiseDetails['name'] }}
                                    </div>
                                    <div class="form-group">
                                        <img style="width: 120px;" src="{{ asset('/admin_assets/uploads/hospital/'.$gethospitalWiseDetails['image']) }}">
                                    </div>
                                    <div class="form-group">
                                ...
                                <table id="sections" class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{ $image['id'] }}</td>
                                            <td>
                                                <img style="width: 60px; height:60px;" src=" {{ asset('admin_assets/uploads/hospital/small/'.$image['image']) }}" >
                                            </td>
                                            <td>
                        ...
                        <div class="col-md-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" action="{{ url('admin/Hospitals-Details-Specialization/') }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-group">
                                            <div class="field_wrapper">
                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                {{-- error meg --}}
                                <hr>
                                <form class="forms-sample" action="{{ url('admin/Hospital-Details-Additional') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                        ...
                                        <div class="col-lg-12">
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="form-group">
                                                            <div class="field_wrapper">
                                                                ...
                                                                <a target="_blank" href="{{ url('admin_assets/uploads/hospital_video/'.$gethospitalWiseDetails1->video) }}">View video</a>&nbsp;&nbsp;
                                                ...
                                                <div class="row">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="checkbox" class="form-control" name="emergency_care" id="emergency_care" value="Yes" @if(!empty($gethospitalWiseDetails1->emergency_care)&& $gethospitalWiseDetails1->emergency_care=="Yes" ) checked="" @endif placeholder="Enter emergency_care">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="emergency_care">Operation Theatre</label>
                                                        <input type="checkbox" class="form-control" name="operation_theatre" id="operation_theatre" value="Yes" @if(!empty($gethospitalWiseDetails1->operation_theatre)&& $gethospitalWiseDetails1->operation_theatre=="Yes" ) checked="" @endif placeholder="Enter operation_theatre">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="emergency_care">Qualified Doctor</label>
                                                        <input type="checkbox" class="form-control" name="qualified_doctor" id="qualified_doctor" value="Yes" @if(!empty($gethospitalWiseDetails1->qualified_doctor)&& $gethospitalWiseDetails1->qualified_doctor=="Yes" ) checked="" @endif placeholder="Enter qualified_doctor">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="emergency_care">Ambulance</label>
                                                        <input type="checkbox" class="form-control" name="ambulance" id="ambulance" value="Yes" @if(!empty($gethospitalWiseDetails1->ambulance)&& $gethospitalWiseDetails1->ambulance=="Yes" ) checked="" @endif placeholder="Enter ambulance">
                                                    </div>
