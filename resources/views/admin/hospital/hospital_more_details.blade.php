                    ...
                    <div class="col-md-8 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                @endif
                                {{-- error meg --}}
                                <form class="forms-sample" action="{{ url('admin/Hospital-More-Details/'.$gethospitalWiseDetails['id']) }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                ...
                                <table id="sections" class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{ $image['id'] }}</td>
                                            <td>
                                                <img style="width: 60px; height:60px;" src=" {{ asset('admin_assets/uploads/hospital/small/'.$image['image']) }}" </td>
                                            <td>
                    ...
                    <div class="col-md-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                @endif
                                {{-- error meg --}}
                                <form class="forms-sample" action="{{ url('admin/ADD-Hospital-Specialization/'.$gethospitalWiseDetails['id']) }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-group">
                                        <div class="field_wrapper">
                                ...
                                <br>
                                <h2 class="card-title">Add Hospital Wise Specialization List</h2>
                                 <br>
                                <table id="sections" class="table table-bordered">
                                    <thead>
                                        <tr>
                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                {{-- error meg --}}
                                <hr>
                                <form class="forms-sample" action="{{ url('admin/Hospital-Details/'.$gethospitalWiseDetails->id) }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    <div class="field_wrapper">
                                                        ...
                                                        <textarea class="form-control" required=""  id="description" name="description" rows="10">@if(!empty($gethospitalWiseDetails1->description )) {{ $gethospitalWiseDetails1->description  }} @else {{ old('description') }} @endif</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    <div class="field_wrapper">
                                                        ...
                                                        <textarea class="form-control" required=""  id="sort_description" name="sort_description" rows="3">@if(!empty($gethospitalWiseDetails1->sort_description )) {{ $gethospitalWiseDetails1->sort_description }} @else {{ old('sort_description') }} @endif</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    <div class="field_wrapper">
                                                        <label for="">Hospital Highlight Point 1</label>
                                                         <input type="text" name="higlight_point_1" required=""   class="form-control" @if(!empty($gethospitalWiseDetails1->higlight_point_1 )) value="{{ $gethospitalWiseDetails1->higlight_point_1  }}" @else value="{{ old('higlight_point_1') }}" @endif >
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    <div class="field_wrapper">
                                                        <label for="">Hospital Highlight Point 2</label>
                                                         <input type="text" name="higlight_point_2" required=""   class="form-control" @if(!empty($gethospitalWiseDetails1->higlight_point_2 )) value="{{ $gethospitalWiseDetails1->higlight_point_2 }}" @else value="{{ old('higlight_point_2') }}" @endif >
                                                    </div>
                                                </div>
                                            </div>
