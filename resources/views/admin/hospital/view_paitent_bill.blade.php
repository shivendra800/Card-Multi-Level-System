                                            ...
                                            <main>
                                                <div class="row contacts">
                                                    <div class="col invoice-to">
                                                        ...
                                                        <h2 class="to">{{ $InvoiceData['paitent_name'] }}</h2>
                                                        ...
                                                        <div class="email"><a href="mailto:{{ $InvoiceData['paitent_email'] }}">{{ $InvoiceData['paitent_email'] }}</a>
                                                        </div>
                                                    </div>
                                                    <div class="col invoice-details">
                                                        <h1 class="invoice-id">INVOICE #{{ $InvoiceData['id'] }}</h1>
                                                        <div class="date">Date of Invoice: {{ date('d-m-Y ',strtotime($InvoiceData['paitent_discharge_date'])); }}</div>
                                                    </div>
                                                </div>
                                                <table>
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="text-left">discount Perecentage</th>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="text-left">
                                                                <h3>
                                                                    <a target="_blank" href="javascript:;">
                                                                        {{ $InvoiceData['paitent_health_card_type'] }}
                                                                    </a>
                                                                </h3>
                                                            </td>
                                                            <td class="text-left">
                                                                <h3>
                                                                    <a target="_blank" href="javascript:;">
                                                                        {{ $InvoiceData['paitent_discount'] }}%
                                                                    </a>
                                                                </h3>
                                                            </td>

                                                            <td class="total">Rs.{{ $InvoiceData['paitent_total_bill'] }}</td>
                                                        </tr>
                                                    ...
                                                    <tfoot>
                                                        <tr>
                                                            ...
                                                            <td>Rs.{{ $InvoiceData['paitent_total_bill'] }}</td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="1"></td>
                                                            <td colspan="2">Discount {{ $InvoiceData['paitent_discount'] }}%</td>
                                                            <td>Rs.{{ $InvoiceData['paitent_discount_amount'] }}</td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="1"></td>
                                                            <td colspan="2">GRAND TOTAL</td>
                                                            <td>Rs.{{ $InvoiceData['after_discount_finall_bill'] }}</td>
                                                        </tr>
                                                    </tfoot>
                                                </table>
