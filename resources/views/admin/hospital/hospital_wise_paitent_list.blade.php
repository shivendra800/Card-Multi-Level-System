                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Patient List in Hospital </h3>
                                                ...
                                                <tr>
                                                      ...
                                                      <td>
                                                        <ul>
                                                            ...
                                                            <li>  <a href="{{ url('/') }}/admin/paitent-disharge-list_details/{{$paitent['id']}}" title="Click to edit this row"><i class="fas fa-list"></i></a></li>
                                                            <li>  <a target="_blank" href="{{ url('/') }}/admin/view-paitent-bill/{{$paitent['id']}}" title="Click to View Inovice this row"><i class="fas fa-file-invoice" style='font-size:20px;color:blue'></i></a></li>
                                                            <li> <a class="label label-info" href="{{ url('/') }}/admin_assets/uploads/hospital_slip/{{ $paitent['hospital_discharge_slip']}}" target="_blank" download="">Discharge Slip
                                                                {{-- <img style="width:90px;" src="{{ asset('/admin_assets/uploads/hospital_slip/'.$paitent['hospital_discharge_slip']) }}" alt="Image here"
                                                                class="cate-image"> --}}
                                                            </a></li>
                                                            <li><a target="_blank" href="https://api.whatsapp.com/send?phone={{$paitent['paitent_mobile']}}&text={{ url('/') }}/admin_assets/uploads/hospital_slip/{{ $paitent['hospital_discharge_slip']}}" download="">
