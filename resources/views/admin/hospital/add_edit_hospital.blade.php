            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form class="forms-sample" @if(empty($createhospital['id'])) action="{{ url('admin/Add-Edit-Hospital') }}" @else action="{{ url('admin/Add-Edit-Hospital/'.$createhospital['id']) }}" @endif method="post" enctype="multipart/form-data">
                            @csrf
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="name" id="name" @if(!empty($createhospital['name'])) value="{{ $createhospital['name'] }}" @else value="{{ old('name') }}" @endif @if($createhospital['id']!="") disabled="" @else required="" @endif placeholder="Enter Full Name" required="" >
                                        </div>

                                        <div class="form-group">
                                            <label for="password">Password</label>
                                            <input type="password" class="form-control" name="password" id="password"  placeholder="Enter Password" @if($createhospital['id']!="") disabled="" @else required="" @endif>
                                        </div>
                                        <div class="form-group">
                                            <label for="address">Hospital Address</label>
                                            <input type="text" class="form-control" name="address" id="address" @if(!empty($createhospital['address'])) value="{{ $createhospital['address'] }}" @else value="{{ old('address') }}" @endif placeholder="Enter Address" required=""  >
                                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" name="email" id="email" @if(!empty($createhospital['email'])) value="{{ $createhospital['email'] }}" @else value="{{ old('email') }}" @endif  @if($createhospital['id']!="") disabled="" @else required="" @endif placeholder="Enter Email" >
                                    </div>
                                    <div class="form-group">
                                        <label for="contact_person_name">Contact Person Name</label>
                                        <input type="text" class="form-control" name="contact_person_name" id="contact_person_name" @if(!empty($createhospital['contact_person_name'])) value="{{ $createhospital['contact_person_name'] }}" @else value="{{ old('contact_person_name') }}" @endif placeholder="Enter contact_person_name" >
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        @foreach ($state as $value)
                                            @if ($createhospital != null)
                                                @if ($value->id == $createhospital['state'])
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="green_card_discount" id="green_card_discount" @if(!empty($createhospital['green_card_discount'])) value="{{ $createhospital['green_card_discount'] }}" @else value="{{ old('green_card_discount') }}" @endif placeholder="Enter green_card_discount" required="" >
                                    </div>
                                    <div class="form-group">
                                        <label for="silver_card_discount">Silver Card Discount</label>
                                        <input type="text" class="form-control" name="silver_card_discount" id="silver_card_discount" @if(!empty($createhospital['silver_card_discount'])) value="{{ $createhospital['silver_card_discount'] }}" @else value="{{ old('silver_card_discount') }}" @endif placeholder="Entersilver_card_discount" required=""  >
                                    </div>
                                    <div class="form-group">
                                        <label for="gold_card_discount">Gold Card Discount</label>
                                        <input type="text" class="form-control" name="gold_card_discount" id="gold_card_discount" @if(!empty($createhospital['gold_card_discount'])) value="{{ $createhospital['gold_card_discount'] }}" @else value="{{ old('gold_card_discount') }}" @endif placeholder="Enter gold_card_discount" required="" >
                                    </div>
                                    <div class="form-group">
                                        <label for="company_discount">Company Commission</label>
                                        <input type="text" class="form-control" name="company_discount" id="company_discount" @if(!empty($createhospital['company_discount'])) value="{{ $createhospital['company_discount'] }}" @else value="{{ old('company_discount') }}" @endif placeholder="Enter Pan Card Number" required="" >
                                    </div>

                                    <div class="form-group">
                                        <label for="health_card_amount">Hospital Image</label>
                                        <input type="file" class="form-control" name="image" id="image" @if(!empty($createhospital['image'])) value="{{ $createhospital['image'] }}" @else value="{{ old('image') }}" @endif required=""   >
                                    </div>
                                </div>
                            </div>
                             <!-- /.card-body -->
