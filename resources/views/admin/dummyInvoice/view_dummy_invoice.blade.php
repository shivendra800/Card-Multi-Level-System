                                            ...
                                            <header>
                                                <div class="row">
                                                    ...
                                                    <div class="col company-details">
                                                        <h2 class="name">
                                                            <a target="_blank" href="{{ $Setting->website_url }}">
                                                               {{ $Setting->website_name }}
                                                            </a>
                                                        </h2>
                                                        <div>{{ $Setting->addresss }}</div>
                                                        <div>{{ $Setting->phone1 }},{{ $Setting->phone2 }}</div>
                                                        <div class="email"><a href="mailto:{{ $Setting->email1 }}">{{ $Setting->email1 }}</a>
                                                    </div>
                                                    <div class="email"><a href="mailto:{{ $Setting->email2 }}">{{ $Setting->email2 }}</a>
                                                    </div>
                                                </div>
                                            </header>
                                            <main>
                                                <div class="row contacts">
                                                    <div class="col invoice-to">
                                                        ...
                                                        <h2 class="to">{{ $InvoiceData->user_name }}</h2>
                                                        {{-- <div class="address">{{ $InvoiceData['city_name'] }},{{ $InvoiceData['district_name'] }},{{ $InvoiceData['state_name'] }}</div> --}}
                                                ...
                                                <table>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="unit">Rs.{{ $InvoiceData->pending_amount	 }}</td>
                                                            <td class="total">Rs.{{ $InvoiceData->received_amount }}</td>
                                                        </tr>
                                                    ...
                                                    <tfoot>
                                                        <tr>
                                                            ...
                                                            <td>Rs.{{ $InvoiceData->received_amount }}</td>
                                                        </tr>
                                                        {{-- <tr>
                                                            <td colspan="2"></td>
