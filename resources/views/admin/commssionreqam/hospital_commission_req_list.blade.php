                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">List of hospital Commsission Percentage</h3>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <table id="example2" class="table table-bordered table-hover dataTable dtr-inline"
                                            ...
                                            <tbody>
                                                @foreach ($hospitalcommis as $CitycomR)
                                                <tr>
                                                      <td>{{ $CitycomR['id'] }}</td>
                                                      ...
                                                      <td>{{ $CitycomR['city_commission'] }}%</td>
                                                        <td>
                                                            ...
                                                            <a title="Edit CitycomR Details" href="{{ url('admin/add-edit-hospital-comm-per/'.$CitycomR['id'] ) }}"<i style="font-size:25px;" class="fa fa-edit"></i></a>
