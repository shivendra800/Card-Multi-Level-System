            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form class="forms-sample" @if(empty($healthcarcom['id'])) action="{{ url('admin/add-edit-Pathology-comm-per') }}" @else action="{{ url('admin/add-edit-Pathology-comm-per/'.$healthcarcom['id']) }}" @endif method="post" enctype="multipart/form-data">
                          @csrf
                          <div class="card-body">
