                ...
                <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered mb-3">
                            ...
                            <li class="list-group-item">
                                <b>Wallet Hospital Commison Amount</b> <a class="float-right">{{ $totalHospitalAmount }}</a>
                            </li>
                            <li class="list-group-item">
                                <b>Wallet Clinic Doctor Commison Amount</b> <a class="float-right">{{ $totalClinicDoctorAmount }}</a>
                            </li>
                            <li class="list-group-item">
                                <b>Wallet Pathology Commison Amount</b> <a class="float-right">{{ $totalClinicPathologyAmount }}</a>
                            </li>
                            ...
                            <li class="list-group-item">
                             ...
                             <strong> <p id="projectIDSelectError"></p></strong>
                                            ...
                                            <span class="username">
                                               <h5  style="color: red;">Transfer Amount  => Rs.<strong>{{ $walletHealth->state_hcms_trans_amt }}</strong></h5>
                                                ...
                                                <h7 style="color: orange;">State Percentage Of {{ $walletHealth->select_refer_user_type }} =>{{  $walletHealth->state_percentage }}% </h7><small>Making Health Card</small>
                                                 <p >
                                                    <br> {{$walletHealth->remark}}.<strong>{{ date('Y-m-d h:i:s',strtotime($walletHealth['created_at'])); }}</strong>
                                                    </p>
                                                    <hr>
                                        </div>
                                        <!-- /.user-block -->
             ...
             <div class="col-sm-12">
                 <table id="example1" class="table table-bordered table-hover dataTable dtr-inline"
                     ...
                     <tbody>
                      ...
                      <!-- commission distribute in three level amount from Pathology -->
