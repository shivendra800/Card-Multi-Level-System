    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                ...
                <h1 class="m-0">District Account</h1>
                ...
                <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered mb-3">
                            ...
                            <li class="list-group-item">
                                <b>Wallet Register Amount</b> <a class="float-right">{{ $totalWalletAmount }}</a>
                            </li>
                            <li class="list-group-item">
                                <b>Wallet Healthcard Amount</b> <a class="float-right">{{ $totalWalletHealthCardAmount }}</a>
                            </li>
                            <li class="list-group-item">
                                <b>Wallet Hospital Commisison Amount</b> <a class="float-right">{{ $totalWalletHospitalComiAmount }}</a>
                            </li>
                            <li class="list-group-item">
                                <b>Wallet Cinic Doctor Commisison Amount</b> <a class="float-right">{{ $totalClinicDoctorAmount }}</a>
                            </li>
                            <li class="list-group-item">
                                <b>Wallet Pathology Commisison Amount</b> <a class="float-right">{{ $totalClinicPathologyAmount }}</a>
                            </li>
                            ...
                            <li class="list-group-item">
                                ...
                                <form  action="{{ url('/') }}/admin/withdrwawalletamount" method="post" >@csrf
                                    <input type="text" id="witdrarw_amount" name="witdrarw_amount" class="form-control" required onkeyup="myFunction();" >
                            ...
                            <div class="tab-pane active" id="activity">
                                ...
                                <div class="post">
                                    ...
                                    <div class="user-block">
                                        ...
                                        <span class="username">
                                            <h5  style="color: orange;">Transfer Amount  =><strong style="color: black;">Rs.{{ $waa->dist_hcms_trans_amt }}</strong></h5>
                                            <h6 style="color: orange;">Total Registation Amount =><strong style="color: black;">Rs.{{ $waa->registration_amt }}</strong></h6>
                                            <h7 style="color: orange;">District Percentage of {{ $waa->select_refer_user_type }} =><strong style="color: black;">{{  $waa->district_percentage }}%</strong></h7>
                                        </span>
                                        <p>
                                ...
                                <div class="timeline timeline-inverse">
                                    <div class="post">
                                        ...
                                        <div class="user-block">
                                            <img src="{{ url('admin_assets/uploads/adminlogin/dummy-user.png') }}" alt="user image">
                                            <span class="username">
                                                <h5  style="color: green;">Transfer Amount  =><strong style="color: black;">Rs.{{ $walletHealth->dist_hcms_trans_amt }}</strong></h5>
                                                <h6 style="color: green;">Total Health Card Amount =><strong style="color: black;">Rs.{{ $walletHealth->health_card_amount }}</strong></h6>
                                                <h7 style="color: green;">District Percentage Of {{ $walletHealth->select_refer_user_type }} =><strong style="color: black;">{{  $walletHealth->district_percentage }}%</strong></h7><small>Making Health Card</small>
                                                 <p >
   ...
   <hr>
    <div class="row">
        <div class="col-sm-12">
            ...
            <!-- commission distribute in three level amount from Doctor -->
