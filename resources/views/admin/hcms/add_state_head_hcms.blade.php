    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    @if ($update_data != null)
                        <h1 class="m-0">Edit State Head(HCMS)</h1>
                    @else
                        <h1 class="m-0">Add State Head(HCMS)</h1>
                    @endif
...
@enderror"
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select name="assign_state" id="assign_state"
                                                ...
                                                value="{{ old('assign_state') }}" required="" >
                                                <option value="">Select State</option>
                                                @foreach ($state as $value)
                                                    @if ($update_data != null)
                                                        @if ($value->id == $update_data->assign_state)
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>State Commission Rate for District Creation</label>
                                            <input type="text"
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number"
                                                ...
                                                @if ($update_data != null) value="{{ $update_data->amount }}" @else value="{{ $commission_reqistation_amount->state_reqistation_amount }}" @endif
