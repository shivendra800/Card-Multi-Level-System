    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    @if ($update_data != null)
                        <h1 class="m-0">Edit City Head(HCMS)</h1>
                    @else
                        <h1 class="m-0">Add City Head(HCMS)</h1>
                    @endif
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="date"
                                                ...
                                                class="form-control  @error('dob') is-invalid @enderror" name="dob" id="dob" required="" >
                                            @error('dob')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number"
                                                ...
                                                onKeyDown="if(this.value.length==12 && event.keyCode>47 && event.keyCode < 58)return false;"  required=""
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control text-dark @error('assign_district') is-invalid @enderror" id="assign_district" name="assign_by_district" required onchange="getassigncity();" >
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>District Commission Rate</label>
                                            <input type="text"
                                                class="form-control @error('commission') is-invalid @enderror"
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>City Commission Rate</label>
                                            <input type="text"
                                                class="form-control @error('commission') is-invalid @enderror"
                                                @if ($update_data != null) value="{{ $update_data->commission }}" @else value="{{ $commission_reqistation_amount->city_commission }}" @endif
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number"
                                                ...
                                                @if ($update_data != null) value="{{ $update_data->amount }}" @else value="{{ $commission_reqistation_amount->city_reqistation_amount }}" @endif
    ...
    function getdiststatewise() {
       ...
       function getcity() {
        ...
        function getassigndiststatewise() {
           ...
           // alert(state_id);s
           @if ($update_data != null)
                var assign_district="{{ $update_data->assign_by_district }}";
            @else
       ...
       function  getassigncity() {
        ...
        @if ($update_data != null)
            var assign_city="{{ $update_data->assign_city }}";
        @else
