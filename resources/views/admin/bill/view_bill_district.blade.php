                                            ...
                                            <main>
                                                <div class="row contacts">
                                                    <div class="col invoice-to">
                                                        ...
                                                        <div class="address">{{ $InvoiceData['street'] }},{{ $InvoiceData['city_name'] }},{{ $InvoiceData['district_name'] }},{{ $InvoiceData['state_name'] }},{{ $InvoiceData['pincode'] }}</div>
                                                ...
                                                <table>
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="text-left">Assign District</th>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="text-left">
                                                                <h3>
                                                                    <a target="_blank" href="javascript:;">
                                                                        {{ $InvoiceData['districtassignnane'] }}
                                                                    </a>
                                                                </h3>
                                                            </td>
                                                            <td class="unit">Rs.{{ $InvoiceData['amount'] }}</td>
                                                            <td class="total">Rs.{{ $InvoiceData['amount'] }}</td>
                                                        </tr>
                                                    ...
                                                    <tfoot>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>Rs.{{ $InvoiceData['total_state_reqistation_amount'] }}</td>
                                                        </tr>
                                                    </tfoot>
                                                </table>
