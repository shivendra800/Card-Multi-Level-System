...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Pathology Commission Report</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
    ...
    <!-- /.content-header -->
    <hr>
    {{-- <a href="{{ url('admin/Pathology-List') }}" --}}
    <div class="row mb-2">
        ...
        <div class="col-12 col-sm-6 col-md-6">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">Pathology -Profit-Rs-{{ $totalPatientdischargeamount }}</span>
        ...
        <div class="col-12 col-sm-6 col-md-6">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">Pathology-Profit-Rs-{{ $totalDayPatientdischargeamount }}</span>
        ...
        <div class="col-12 col-sm-6 col-md-6">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">Pathology-Profit-Rs-{{ $totalMonthsPatientdischargeamount }}</span>
        ...
        <div class="col-12 col-sm-6 col-md-6">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">Pathology-Profit-Rs-{{ $totalYearPatientdischargeamount }}</span>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Pathology Commission Report </h3>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                              <td>{{ $value->id }}</td>
                                                  <td>{{ $value->clininc_name }} <br>State:  {{ $value->state_name }} <br> District:{{ $value->district_name }}
