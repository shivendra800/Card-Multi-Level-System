...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Hospital Commission Report</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Hospital Commission Report </h3>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($gettbldatawallet_hospital as $index=>$value)
                                            <tr>
                                                <td>{{ $index+1 }}</td>
                                                  <td>{{ $value->hospital_name }} <br>State:  {{ $value->state_name }} <br> District:{{ $value->district_name }}
