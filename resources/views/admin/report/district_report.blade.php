...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">District Commission Report</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">District Commission Report</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-12 table-responsive">
                                        ...
                                        <tbody>
                                            <?php $total = 0; ?>
                                              ...
                                              <?php $total += $stateWalletTransHis['dist_hcms_trans_amt']; ?>
                                                   <tr>
                                                    <td>{{ $index +1 }}</td>
                                                    <td>{{ ucfirst($stateWalletTransHis['select_refer_user_type']) }}</td>
                                                    <td>{{ $stateWalletTransHis['district_percentage'] }}%</td>
                                                    <td>Rs.{{ $stateWalletTransHis['dist_hcms_trans_amt'] }}</td>
                                                    <td><button type="button" class="btn btn-waring"><strong style="color: red;">{{ $stateWalletTransHis['state_name'] }}-{{ $stateWalletTransHis['district_name']}}</strong></button></td>
                                             ...
                                             <?php $total += $stateWalletHospitalTrans->district_per_amount; ?>
                                             <tr>
                                               <td>{{ $index +1 }}</td>
                                              ...
                                              <td>{{ $stateWalletHospitalTrans->district_per}}%</td>
                                              <td>Rs.{{ $stateWalletHospitalTrans->district_per_amount}}</td>
                                              <td><button type="button" class="btn btn-waring"><strong style="color: red;">{{ $stateWalletHospitalTrans->state_name}}-{{ $stateWalletHospitalTrans->district_name}}</strong></button></td>
                                            ...
                                            <?php $total += $stateWalletDoctoralTrans->district_per_amount; ?>
                                            <tr>
                                              <td>{{ $index +1 }}</td>
                                             ...
                                             <td>{{ $stateWalletDoctoralTrans->district_per}}%</td>
                                             <td>Rs.{{ $stateWalletDoctoralTrans->district_per_amount}}</td>
                                             <td><button type="button" class="btn btn-waring"><strong style="color: red;">{{ $stateWalletDoctoralTrans->state_name}}-{{ $stateWalletDoctoralTrans->district_name}}</strong></button></td>
                                            ...
                                            <?php $total += $stateWalletPathologyalTrans->district_per_amount; ?>
                                            <tr>
                                              <td>{{ $index +1 }}</td>
                                             ...
                                             <td>{{ $stateWalletPathologyalTrans->district_per}}%</td>
                                             <td>Rs.{{ $stateWalletPathologyalTrans->district_per_amount}}</td>
                                             <td><button type="button" class="btn btn-waring"><strong style="color: red;">{{ $stateWalletPathologyalTrans->state_name}}-{{ $stateWalletPathologyalTrans->district_name}}</strong></button></td>
