...
@section('title', 'Book Appointent With Doctor')
...
<div class="inner-page-title inner-page-header-bg">
    <div class="container">
      <h1>Book  Your Appointent With Doctor Here</h1>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title"> Book Appoitment<small> Doctor </small></h3>
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form class="forms-sample"  action="{{ url('Book-Doctor-Appointent/'.$gethospitaldatasingledata->slug) }}"  method="post" enctype="multipart/form-data">
                                @csrf
                            <div class="row">
