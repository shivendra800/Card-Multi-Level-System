...
<!--      <div class="item"><img src="{{ asset('/admin_assets/uploads/doctor/'.$doctor->image) }}" alt=""></div>-->
<!--      {{-- @foreach ($getmultiimages as $getimages ) --}}-->
<!--      @if(!empty($getmultiimages->image))-->
<!--      <div class="item"><img src="{{ asset('/admin_assets/uploads/doctor/small/'.$doctor->multi_images) }}" alt=""></div>-->
<!--      @endif-->
<!--      {{-- @endforeach --}}-->
<!--    </div>-->
...
<!--              <h1>{{ $doctor->name }}</h1>-->
<!--              <div class="location"><i class="bi bi-geo-alt"></i>{{ $doctor->address }}, {{ $doctor->city_name }},{{ $doctor->district_name }},{{ $doctor->state_name }}</div>-->
<!--            </div>-->
<!--          </div>-->
<!--        </div>-->
<!--      </div>-->
...
<!--        <a href="{{ asset('admin_assets/uploads/doctor_video/'.$doctor->video) }}">-->
<!--        <source src="{{ asset('admin_assets/uploads/doctor_video/'.$doctor->video) }}"  type="video/mp4" class="venobox" data-autoplay="true" data-vbtype="video"><i class="bi bi-play-circle"></i>Video</a>-->
<!--        <a href="{{ asset('/admin_assets/uploads/doctor/'.$doctor->image) }}" class="venobox" data-gall="gallery1"><i class="bi bi-camera"></i> Photos</a> <a href="{{ asset('/admin_assets/uploads/doctor/'.$doctor->image) }}" class="venobox d-none" data-gall="gallery1"></a>-->
<!--        @if(!empty($doctor->multi_images))-->
<!--         <a href="{{ asset('/admin_assets/uploads/doctor/medium/'.$doctor->multi_images) }}" class="venobox d-none" data-gall="gallery1"></a> <a href="{{ asset('/admin_assets/uploads/doctor/'.$doctor->multi_images) }}" class="venobox d-none" data-gall="gallery1"></a>-->
<!--          @endif-->
<!--        </div>-->
<!--    @endforeach-->
...
<!--</div>-->
 ...
 <div class="details-page-bammer">
      <div class="details-page-bammer-carousel owl-carousel owl-theme">
              @foreach ($getdoctordata as $imges)
      <div class="item"><img src="{{ asset('/admin_assets/uploads/doctor/'.$imges->image) }}" alt=""></div>
          <!--<div class="item"><img src="{{ asset('/admin_assets/uploads/doctor/'.$imges->multi_images) }}" alt=""></div>-->
      @endforeach
    </div>
    @foreach ($getdoctordata as $hospital)
    ...
    <div class="details-page-bammer-caption-btn">
        <a href="{{ asset('admin_assets/uploads/doctor_video/'.$hospital->video) }}">
        <source src="{{ asset('admin_assets/uploads/doctor_video/'.$hospital->video) }}"  type="video/mp4" class="venobox" data-autoplay="true" data-vbtype="video"><i class="bi bi-play-circle"></i>Video</a>
        <a href="{{ asset('/admin_assets/uploads/doctor/'.$hospital->image) }}" class="venobox" data-gall="gallery1"><i class="bi bi-camera"></i> Photos</a> <a href="{{ asset('/admin_assets/uploads/hospital/'.$hospital->image) }}" class="venobox d-none" data-gall="gallery1"></a>
      ...
      <div class="row">
        <div class="col-lg-9">
          ...
          <div id="overview" class="details-page-content-box mb-20">
            ...
            <div class="row row-cols-lg-2 row-cols-md-2 row-cols-sm-1 row-cols-1">
              <div class="col mb-20">
                @if(!empty($doctor->sort_description))
                <p>{{ $doctor->sort_description }}.</p>
                @endif
                <ul class="d-inline-block w-100 list">
                    @if(!empty($doctor->higlight_point_1))
                  <li><i class="bi bi-arrow-right-circle"></i> {{ $doctor->higlight_point_1 }}.</li>
                  @endif
                  @if(!empty($doctor->higlight_point_2))
                  <li><i class="bi bi-arrow-right-circle"></i>{{ $doctor->higlight_point_2 }}.</li>
                  @endif
                </ul>
              </div>
              <div class="col mb-20">
                @if(!empty($doctor->image))
                <div class="details-page-img"><img src="{{ asset('/admin_assets/uploads/doctor/'.$doctor->image) }}" alt=""></div>
                @endif
              </div>
            </div>
          </div>
        ...
        <div class="col-lg-3">
          ...
          <div class="hours-box mb-30">
            <h4 class="mb-8"> Doctor Specialities List</h4>
            <ul>
                @foreach ($getdoctorwsiespec as  $getdoctorwsiespec)


              <li>
                @if(!empty($getdoctorwsiespec->specialization_name))
                <p>{{ $getdoctorwsiespec->specialization_name }}</p>
                @endif
              </li>
              @endforeach
            </ul>
          ...
          <div class="hours-box mb-30">
            ...
            <div class="place"><i class="bi bi-geo-alt"></i> {{ $doctor->address }}, {{ $doctor->city_name }},{{ $doctor->district_name }},{{ $doctor->state_name }}</div>
            <ul>
              <li>
                <h5>Monday-Thursday:</h5>
                @if(!empty($doctor->mon_thur))
                <p>{{ $doctor->mon_thur }}</p>
                @endif
              </li>
              <li>
                <h5>Friday-Saturday:</h5>
                @if(!empty($doctor->time_firday))
                <p>{{ $doctor->time_firday }}</p>
                @endif
              </li>
              <li>
                <h5>Sunday:</h5>
                @if(!empty($doctor->time_sunday))
                <p>{{ $doctor->time_sunday }}</p>
                @endif
              </li>
            </ul>
          </div>
          ...
          {{-- <form class="side-book-appointment mb-30">
            <div class="title">Book Appointment</div>
            <input type="text" class="form-control mb-20" placeholder="Name*">
            <input type="email" class="form-control mb-20" placeholder="Email*">
            <input type="date" class="form-control mb-20">
            <input type="time" class="form-control mb-20">
            <select class="form-select sidebar-specialities mb-20">
