...
<div class="inner-page-title inner-page-header-bg">
    <div class="container">
      <h1>Online Reqistation Doctors</h1>
      <div class="breadcrumb-box">
        <!-- breadcrumb -->
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="#"><i class="bi bi-house"></i> Home</a></li>
          <li class="breadcrumb-item active" aria-current="page">Reqistation Doctors</li>
        </ol>
      </div>
    </div>
  </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form class="forms-sample"  action="{{ url('Register-Doctor') }}"   method="post" enctype="multipart/form-data">
                        @csrf
                    <div class="row">
