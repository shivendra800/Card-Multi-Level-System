...
<div class="inner-page-title inner-page-header-bg">
    <div class="container">
      <h1>Online Reqistation Pathology</h1>
      <div class="breadcrumb-box">
        <!-- breadcrumb -->
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="#"><i class="bi bi-house"></i> Home</a></li>
          <li class="breadcrumb-item active" aria-current="page">Reqistation Pathology</li>
        </ol>
      </div>
    </div>
  </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form class="forms-sample"  action="{{ url('Register-Pathology') }}"   method="post" enctype="multipart/form-data">
                        @csrf
                    <div class="row">
                        ...
                        <div class="col-md-6">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <label for="name">Pathology Name</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="clininc_name" id="clininc_name" @if(!empty($createpathology['clininc_name'])) value="{{ $createpathology['clininc_name'] }}" @else value="{{ old('clininc_name') }}" @endif @if($createpathology['id']!="") disabled="" @else required="" @endif placeholder="Enter Fclininc_name" required="" >
                                    </div>

                                    <div class="form-group">
                                        <label for="password">Password</label>
                                        <input type="password" class="form-control" name="password" id="password"  placeholder="Enter Password" @if($createpathology['id']!="") disabled="" @else required="" @endif>
                                    </div>
                                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control" name="image" id="image" @if(!empty($createpathology['image'])) value="{{ $createpathology['image'] }}" @else value="{{ old('image') }}" @endif required=""   >
                                </div>
                            </div>
                        </div>
                         <!-- /.card-body -->
